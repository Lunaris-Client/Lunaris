...
class NotificationPoller {
  ...
  static Future<void> pollAllServers() async {
    ...
    for (final account in accounts) {
      ...
      final apiKey = await _secureStorage.read(key: 'api_key_$serverUrl');
      ...
      try {
        ...
        debugPrint('[NotificationPoller] error for $serverUrl: $e');
      }
    }
  }
}
